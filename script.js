document.addEventListener('DOMContentLoaded', () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      signature: {
        name: 'Janosch Trimborn',
        path: 'M10 85 Q20 45 40 50 Q55 52 60 75 Q62 90 45 92 Q30 93 25 80 Q22 70 35 65 Q50 58 70 75 Q85 88 105 70 Q120 55 128 45 Q140 32 150 50 Q160 65 145 90 Q135 100 120 95 Q105 88 110 75 Q115 65 130 70 Q150 78 165 55 Q180 38 195 48 Q210 58 200 95 Q195 110 175 105'
      }
    },
    {
      title: 'IDEEN, WIRKSAM.',
      ...
      signature: {
        name: 'Leopold Holtmann',
        path: 'M12 88 Q25 50 45 55 Q62 58 68 80 Q70 95 50 98 Q32 99 28 82 Q25 70 40 62 Q58 52 75 78 Q92 100 115 75 Q130 60 140 48 Q152 35 162 52 Q172 68 158 95 Q148 108 130 102 Q112 95 118 80 Q125 68 145 75 Q168 85 185 58 Q202 38 218 50 Q235 62 225 100 Q220 115 200 110'
      }
    }
  ];
  ...
  const renderSignature = slide => {
    ...
    setTimeout(() => {
      signature.innerHTML = `
        <path d="${slide.signature.path}" fill="none" stroke="#2e6ff2" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
        <text x="130" y="115" fill="#2e6ff2" font-size="32" font-weight="500" font-family="Inter, sans-serif">${slide.signature.name}</text>`;
